...
var dialogues = [
	'That’s weird, why wouldn’t you remember doing a task you do on a daily basis?',
	'Well... It’s just that I wanted to make sure I’d done it properly.',
	'Please stop questioning the witness with something irrelevant to the case.',
	'(Tsk... I already know that.)',
	'Hmm... alright, then what happened when you returned to the pool area?',
]
...
@onready var sunny_sprite_animation = $sunny_sprite/sunny_sprite_animation2
...
func update_sprites(sprite: int):
	...
	match sprite:
		...
		5: 
			...
			sunny_sprite_animation.play("NormalTalk")
			if is_typing:
				await start_text_update()
