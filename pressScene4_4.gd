...
var dialogues = [
	"Purely coincidental, you say? What exactly were you doing at the pool area?",
	"I... I was just taking a walk to clear my head. It was a stressful day.",
	"A walk to clear your head on a stressful day, huh?",
	"It’s curious that your ‘coincidental’ presence just happened to align with the exact time of the crime.",
	"...We’ll surely get to the bottom of this!"
]
