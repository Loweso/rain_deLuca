...
var dialogues = [
	"So it was possible that not only Ms. Yala was the last one to be around the same area as Ms. Thirsty...",
	"...but also someone else, perhaps someone unnoticed, slipping into the shadows, unseen, unaccounted for?",
	'I suppose it’s possible, but I didn’t see anyone else.',
	"But your certainty is based on your own observation, correct? Your own limited perspective?",
	'Yes... but...',
