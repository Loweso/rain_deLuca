...
var dialogues = [
	"Ms. Flower, you said you represented Sirina in a high-profile case. Could you specify what kind of case that was?",
	"It was... uh... a corporate lawsuit involving her company.",
	"A corporate lawsuit? And you believe that this past case would compel you to watch a tennis match? That doesn't add up.",
	"I... I just wanted to see her play. Is that a crime?",
	"I... I had my reasons!",
	"Your reasons, or were you perhaps there for something else? Something more sinister?",
	"No! I just wanted to watch the match, I swear!",
	"Ms. Flower, you need to provide a more coherent explanation. Do you recall meeting me that day?"
]
